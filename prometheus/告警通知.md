...
```
:27 c720111.xiodi.cn alertmanager[29273]: level=error ts=2020-03-31T06:46:27.088Z caller=dispatch.go:301 component=dispatcher msg="Notify for alerts failed" num_alerts=2 err="*smtp.plainAuth auth: unencrypted connection"
```
