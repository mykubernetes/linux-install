...
# mkdir /etc/ansible/roles/defined-x-task/tasks
# touch /etc/ansible/roles/defined-x-task/tasks/main.yml
...
执行过程
```
# ansible-playbook when-role.yml 

PLAY [node] ********************************************************************************************************************************************

TASK [Gathering Facts] *********************************************************************************************************************************
Monday 27 September 2021  11:14:50 -0400 (0:00:00.619)       0:00:00.619 ****** 
ok: [node01]

PLAY RECAP *********************************************************************************************************************************************
node01                     : ok=1    changed=0    unreachable=0    failed=0   

Monday 27 September 2021  11:14:52 -0400 (0:00:02.574)       0:00:03.194 ****** 
=============================================================================== 
...
TASK [Gathering Facts] *********************************************************************************************************************************
Monday 27 September 2021  11:17:47 -0400 (0:00:00.115)       0:00:00.115 ****** 
ok: [node01]

PLAY RECAP *********************************************************************************************************************************************
node01                     : ok=1    changed=0    unreachable=0    failed=0   

Monday 27 September 2021  11:17:48 -0400 (0:00:00.909)       0:00:01.024 ****** 
=============================================================================== 
...
# cat /etc/ansible/roles/task-with-when/tasks/main.yml
- name: Set a variable
  set_fact:
    x: foo
  when: x is not defined
...
TASK [Gathering Facts] *********************************************************************************************************************************
Monday 27 September 2021  11:20:34 -0400 (0:00:00.070)       0:00:00.070 ****** 
ok: [node01]

TASK [include_role : task-with-when] *******************************************************************************************************************
Monday 27 September 2021  11:20:35 -0400 (0:00:00.954)       0:00:01.025 ****** 

TASK [task-with-when : Set a variable] *****************************************************************************************************************
Monday 27 September 2021  11:20:35 -0400 (0:00:00.064)       0:00:01.090 ****** 
ok: [node01]

TASK [task-with-when : Print a variable] ***************************************************************************************************************
Monday 27 September 2021  11:20:35 -0400 (0:00:00.077)       0:00:01.167 ****** 
ok: [node01] => {
    "x": "foo"
}
...
Monday 27 September 2021  11:20:35 -0400 (0:00:00.048)       0:00:01.215 ****** 
=============================================================================== 
Gathering Facts --------------------------------------------------------------------------------------------------------------------------------- 0.95s
task-with-when : Set a variable ----------------------------------------------------------------------------------------------------------------- 0.08s
include_role : task-with-when ------------------------------------------------------------------------------------------------------------------- 0.06s
task-with-when : Print a variable --------------------------------------------------------------------------------------------------------------- 0.05s
```
