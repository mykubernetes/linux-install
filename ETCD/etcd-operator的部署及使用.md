...
https://github.com/coreos/etcd-operator/blob/master/example/rbac/cluster-role-binding-template.yaml

# cluster-role-template.yaml
https://github.com/coreos/etcd-operator/blob/master/example/rbac/cluster-role-template.yaml
```
...
```
# kubectl logs -f etcd-operator-545df8d445-qpf6n -n operator
