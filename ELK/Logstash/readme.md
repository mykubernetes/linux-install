...
| geoip | 添加关于IP地址的地理信息 | [logstash-filter-geoip](https://github.com/logstash-plugins/logstash-filter-geoip) |
| grok | 将非结构化事件数据解析为字段 | [logstash-filter-grok](https://github.com/logstash-plugins/logstash-filter-grok) |
...
| json | 解析JSON事件 | [logstash-filter-json](https://github.com/logstash-plugins/logstash-filter-json) |
...
| mutate | 在字段上执行转变 | [logstash-filter-mutate](https://github.com/logstash-plugins/logstash-filter-mutate) |
